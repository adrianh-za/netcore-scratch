...
public static class PeopleEndpointsV2
{
    public static void MapPeopleEndpointsV2(this IEndpointRouteBuilder app)
    {
        ...
        group.MapGet("/typed-results", GetPeopleTypedResults)
            .WithName("GetPeople-TypesResults-V2")
        ...
        group.MapGet("/produces", GetPeopleIResult)
            .WithName("GetPeople-Produces-V2")
